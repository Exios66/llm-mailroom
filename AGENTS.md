...
PYTHONPATH=src python src/scripts/run_pilot.py --mock         # pilot-test pipeline machinery (fake LLM, full 22-sample live-manifest set)
...
PYTHONPATH=src python src/scripts/run_hf_pilot.py --real --per-class 1  # stratified docclass-merged subset → Langfuse session pilot-hf-<stamp>
