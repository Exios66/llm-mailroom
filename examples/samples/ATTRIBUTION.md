...
The contract PDFs under `examples/samples/contract/` come from the
...
The six `legalbench_*.txt` files under `examples/external/legalbench/` are the
...
The six `pileoflaw_*.txt` files under `examples/external/pileoflaw/` are U.S.
