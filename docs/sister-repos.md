...
│  claims-data-eda       │   └──────────┬───────────────────┘
│  atticus-investigation │              │ pinned dependency @f815544 (0.9.0)
└────────────────────────┘              ▼
                          ┌──────────────────────────────┐
                          │     llm-dojo-scoring         │
...
- Pinned as a git dependency (`@f815544` / package 0.9.0 at time of writing); mailroom wires
